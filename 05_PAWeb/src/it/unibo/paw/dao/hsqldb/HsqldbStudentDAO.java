...
public class HsqldbStudentDAO implements StudentDAO {
	...
	static String find_student_by_lastname = read_all +
			"WHERE " + LASTNAME + " = ? ";
	...
	public StudentDTO read(int code) {
		...
		// --- 5. Gestione di eventuali eccezioni ---
			...
			System.err.println("read(): failed to retrieve entry with id = " + code + ": " + e.getMessage());
			e.printStackTrace();
		}
		// --- 6. Rilascio, SEMPRE E COMUNQUE, la connessione prima di restituire il controllo al chiamante
		finally {
	...
	public boolean delete(int code) {
		...
		// --- 5. Gestione di eventuali eccezioni ---
			...
			System.err.println("delete(): failed to delete entry with id = " + code + ": " + e.getMessage());
			e.printStackTrace();
		}
		// --- 6. Rilascio, SEMPRE E COMUNQUE, la connessione prima di restituire il controllo al chiamante
		finally {
